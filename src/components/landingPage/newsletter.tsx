      ...
      <section>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="pb-6 md:pb-10">
            ...
            {/* CTA box */}
            <div className="relative bg-gray-200 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl overflow-hidden" data-aos="zoom-y-out">
              ...
              <div className="relative flex flex-col lg:flex-row justify-between items-center">
                ...
                <div className="text-center lg:max-w-xl flex flex-col md:flex-row lg:flex-col">
                    <div className='flex flex-col max-w-md px-10'>
                        <h3 className="h3 font-bold text-black mb-2 text-2xl">Want to start?</h3>
                        <p className="text-gray-800 text-lg mb-6">Register your email here and support GoalTac to be the best it can be with your feedback. Also, connect with us on LinkedIn!</p>
                    </div>
